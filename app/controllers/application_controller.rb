...
class ApplicationController < ActionController::API
     ...
     # Show error message when trying to use invalid parameters to create an entity
     rescue_from ActiveRecord::RecordInvalid, with: :invalid_params
     # Show error message when the requested resource is not found
     rescue_from ActiveRecord::RecordNotFound, with: :render_not_found
   
     # This method is called to generate an ID for tables, encoded as strings
